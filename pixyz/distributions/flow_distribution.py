...
class TransformedDistribution(Distribution):
    ...
    def get_log_prob(self, x_dict, sum_features=True, compute_jacobian=False):
        """
        ...
        # prior
        log_prob_prior = self.prior.get_log_prob(inf_dict, sum_features=sum_features)
...
class InverseTransformedDistribution(Distribution):
    ...
    def get_log_prob(self, x_dict, sum_features=True):
        ...
        # prior
        log_prob_prior = self.prior.get_log_prob(output_dict, sum_features=sum_features)
